    ...
    >
      ...
      >
          ...
          {navLinks.map((link, index) => (
            <li key={index}>
              <Link
                ...
                className="cursor-pointer rounded-xl border border-transparent px-4 py-2 text-base font-medium text-slate-600 transition-all duration-200 hover:border-white/20 hover:bg-white/60 hover:text-slate-900 hover:shadow-sm hover:backdrop-blur-xl dark:border-transparent dark:text-slate-400 dark:hover:border-white/10 dark:hover:bg-white/10 dark:hover:text-white"
              >
                {link.label}
              </Link>
            </li>
        ...
        <div className="flex items-center gap-3">
          <ThemeSwitcher className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-xl border border-white/20 bg-white/40 text-lg text-slate-600 shadow-sm backdrop-blur-xl transition-colors duration-200 hover:bg-white/60 hover:text-cyan-600 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:bg-white/10 dark:hover:text-cyan-400" />
          
          {/* Mobile Menu Button */}
          <button
            onClick={handleMenuToggle}
            className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/20 bg-white/40 text-lg text-slate-600 shadow-sm backdrop-blur-xl transition-colors duration-200 hover:bg-white/60 hover:text-cyan-600 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:bg-white/10 dark:hover:text-cyan-400 lg:hidden"
