...
const Services = () => {
  return (
    <section id="services" className="relative w-full py-16 sm:py-24 lg:py-32">
              ...
              {servicesData.map((service, index) => (
                ...
                >
                  <div>
                    ...
                    <div className="mb-8">
                      <h4 className="mb-4 text-xs font-semibold tracking-wider text-cyan-600 dark:text-cyan-400">
                        Core Technologies
                      </h4>
                  ...
                  <a
                    href="#contact"
                    className="group/btn inline-flex items-center gap-2 font-semibold tracking-wider text-slate-900 transition-all hover:gap-3 dark:text-white"
                  >
                    Get Started
