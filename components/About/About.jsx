          ...
          <div className="col-span-1 flex lg:col-span-3 2xl:col-span-2">
            <div className="mx-2 my-auto max-md:pt-16 sm:px-16 2xl:p-24">
              ...
              <div className="mt-12 grid grid-cols-4 gap-x-4 gap-y-8 max-sm:grid-cols-2 max-sm:grid-rows-2 max-sm:items-center max-sm:justify-items-center">
                <div className="experiences-after flex size-24 flex-col items-center justify-center rounded-lg bg-slate-800 p-2 after:bg-pink-500">
                  <span className="text-2xl font-bold text-slate-300">4+</span>
                  <span className="text-lg font-semibold text-slate-400">
                    Years
                  </span>
                </div>
                <div className="experiences-after flex size-24 flex-col items-center justify-center rounded-lg bg-slate-800 p-2 after:bg-yellow-500">
                  <span className="text-2xl font-bold text-slate-300">11</span>
                  <span className="text-lg font-semibold text-slate-400">
                    Projects
                  </span>
                </div>
                <div className="experiences-after flex size-24 flex-col items-center justify-center rounded-lg bg-slate-800 p-2 after:bg-green-500">
                  <span className="text-2xl font-bold text-slate-300">7</span>
                  <span className="text-lg font-semibold text-slate-400">
                    Clients
                  </span>
                </div>
                <div className="experiences-after flex size-24 flex-col items-center justify-center rounded-lg bg-slate-800 p-2 after:bg-indigo-500">
