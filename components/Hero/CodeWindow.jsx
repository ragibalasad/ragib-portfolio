...
const CodeWindow = ({ text }) => {
  ...
  return (
    <div class="relative flex w-full overflow-hidden rounded-xl bg-slate-800 shadow-xl dark:bg-gray-800/70 dark:ring-1 dark:ring-inset dark:ring-white/10 dark:backdrop-blur">
